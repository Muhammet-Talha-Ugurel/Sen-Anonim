...
class Message extends Model {
  ...
  const Message._internal({required this.id, message, required chatID, required userID, createdAt, updatedAt}): _message = message, _chatID = chatID, _userID = userID, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Message({String? id, String? message, required String chatID, required String userID}) {
  ...
  Message copyWith({String? id, String? message, String? chatID, String? userID}) {
    return Message._internal(
      id: id ?? this.id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'message': _message, 'chatID': _chatID, 'userID': _userID, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
