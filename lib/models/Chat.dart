...
class Chat extends Model {
  ...
  const Chat._internal({required this.id, name, description, Messages, createdAt, updatedAt}): _name = name, _description = description, _Messages = Messages, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Chat({String? id, String? name, String? description, List<Message>? Messages}) {
  ...
  Chat copyWith({String? id, String? name, String? description, List<Message>? Messages}) {
    return Chat._internal(
      id: id ?? this.id,
      name: name ?? this.name,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'name': _name, 'description': _description, 'Messages': _Messages?.map((Message? e) => e?.toJson()).toList(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
